classdef flowEQ_lite < audioPlugin & matlab.System
    ...
    properties (Constant)
        PluginInterface = audioPluginInterface(...
            ...
            'VendorVersion','0.9.0',...
            ... % GUI Configuration
            audioPluginGridLayout('RowHeight',[25 25 25 25 25 25 25],...
                                  'ColumnWidth',[25 25 50 25 25 25 50 25 25],...
                                  'RowSpacing',15,...
                                  'ColumnSpacing',15,...
                                  'Padding',[20 20 20 20]),...
            ...
            audioPluginParameter('extend',          'DisplayName','Extend (x2)',       'Label','',   'Mapping',{'enum', 'Off', 'On'},                     'Layout',[4,8; 4,9],   'DisplayNameLocation', 'below'),...
            ...
            audioPluginParameter('gainCompensation','DisplayName','Auto Gain Comp.',   'Label','',   'Mapping',{'enum', 'Off', 'On'},                     'Layout',[5,1; 5,2],   'DisplayNameLocation', 'right', 'Style', 'checkbox'),...          
