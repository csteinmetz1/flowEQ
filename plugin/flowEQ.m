classdef flowEQ < audioPlugin & matlab.System
    ...
    properties 
        ...
        gainUpdateRate   =  GainUpdateRate.slow;
    ...
    properties (Constant)
        PluginInterface = audioPluginInterface(...
            ...
            audioPluginParameter('gainUpdateRate',  'DisplayName','Update Rate',       'Label','',   'Mapping',{'enum', 'Fast','Medium','Slow'},          'Layout',[11,2; 11,2], 'DisplayNameLocation', 'below', 'Style', 'dropdown'),...          
