classdef flowEQ < audioPlugin & matlab.System
    ...
    properties (Constant)
        PluginInterface = audioPluginInterface(...
            ...
            'VendorVersion','0.5.0',...
            ... % GUI Configuration
            audioPluginGridLayout('RowHeight',[25 25 25 25 25 25 25 25 25],'ColumnWidth',[75 75 25 100 100 100 100 100 100],'RowSpacing',15,'ColumnSpacing',15,'Padding',[15 15 15 15]),...
            ...
            audioPluginParameter('strength',       'DisplayName','Strength',          'Label','',   'Mapping',{'lin',  0.01, 1},                           'Layout',[7,5; 7,8], 'DisplayNameLocation', 'left', 'EditBoxLocation', 'right'),...
